...
namespace ao::test {
    ...
    TEST(BasicBuffer, UpdateFragment) {
        ...
        // Out of range update
        ASSERT_EXCEPTION<core::IndexOutOfRangeException>([&]() { b.updateFragment(10, o); });
        ASSERT_EXCEPTION<core::IndexOutOfRangeException>([&]() { b2.updateFragment(10, o); });
    ...
    TEST(BasicBuffer, Offset) {
        ...
        // Out of range
        ASSERT_EXCEPTION<core::IndexOutOfRangeException>([&]() { b.offset(10); });
        ASSERT_EXCEPTION<core::IndexOutOfRangeException>([&]() { b2.offset(10); });
    }
